...
class ReceitaMedicaAdmin(admin.ModelAdmin):
    ...
    search_fields = ['consultamediconome_completo', 'consultatriagem_enfermeiroagendamentotriagem_IAficha_medica_pacientepacientenome_completo']
...
class ReceitaItemAdmin(admin.ModelAdmin):
    ...
    search_fields = ['receitaid', 'medicamentonome_medicamento']
...
class ExamesAdmin(admin.ModelAdmin):
    ...
    search_fields = ['consultamedico__nome_completo', 'exame_solicitado']
