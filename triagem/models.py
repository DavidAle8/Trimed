...
class TriagemEnfermeiro(models.Model):
    ...
    ficha_clinica_paciente = models.OneToOneField(FichaMedicaPaciente, on_delete=models.CASCADE, verbose_name="Ficha Médica do Paciente") 
    ...
    def __str__(self):
        paciente_nome = self.ficha_clinica_paciente.paciente.nome_completo
...
class triagemIA(models.Model):
    ...
    agendamento_paciente = models.OneToOneField(Agendamento, on_delete=models.CASCADE, verbose_name="Agendamento do paciente")
